...
public class DiscordPresence {
    ...
    public static void start() {
        ...
        rpc.Discord_Initialize("991035162152296478", handlers, true, "");
        ...
        DiscordPresence.presence.largeImageKey = "chickenwings_cc";
        DiscordPresence.presence.largeImageText = "ChickenWings.cc";
        ...
        thread = new Thread(() -> {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                if (RPC.INSTANCE.catMode.getValue().booleanValue()) {
                    ...
                    DiscordPresence.presence.largeImageKey = "chickenwings_cc" + index;
                    ++index;
                }
                rpc.Discord_UpdatePresence(presence);
                try {
