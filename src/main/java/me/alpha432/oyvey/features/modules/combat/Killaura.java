...
import me.alpha432.oyvey.util.DamageUtil2;
...
public class Killaura extends Module {
    ...
    private void doKillaura() {
        ...
        int wait = !this.delay.getValue().booleanValue() ? 0 : (int) (DamageUtil2.getCooldownByWeapon(mc.player) * (this.tps.getValue().booleanValue() ? OyVey.serverManager.getTpsFactor() : 1.0F));
    ...
    private Entity getTarget() {
        ...
        for (Entity entity : mc.world.playerEntities) {
            ...
            if (entity instanceof EntityPlayer && DamageUtil2.isArmorLow((EntityPlayer) entity, 18)) {
                target = entity;
                break;
            }
