...
public class Notifications
        extends Module {
    private static final String fileName = "ChickenWings.cc/util/ModuleMessage_List.txt";
    ...
    public void onUpdate() {
        if (this.entities.getValue().booleanValue() && this.Ghasts.getValue().booleanValue()) {
            for (Entity entity : Notifications.mc.world.getLoadedEntityList()) {
                ...
                if (this.Desktop.getValue().booleanValue()) {
                    this.icon.displayMessage("ChickenWings.cc", "I found a ghast at: " + Math.round(entity.getPosition().getX()) + ", " + Math.round(entity.getPosition().getY()) + ", " + Math.round(entity.getPosition().getZ()) + ".", TrayIcon.MessageType.INFO);
                }
        ...
        if (this.entities.getValue().booleanValue() && this.Donkeys.getValue().booleanValue()) {
            for (Entity entity : Notifications.mc.world.getLoadedEntityList()) {
                ...
                if (this.Desktop.getValue().booleanValue()) {
                    this.icon.displayMessage("ChickenWings.cc", "I found a donkey at: " + Math.round(entity.getPosition().getX()) + ", " + Math.round(entity.getPosition().getY()) + ", " + Math.round(entity.getPosition().getZ()) + ".", TrayIcon.MessageType.INFO);
                }
                if (!this.Sound.getValue().booleanValue()) continue;
                Notifications.mc.player.playSound(SoundEvents.BLOCK_ANVIL_DESTROY, 1.0f, 1.0f);
            }
        ...
        if (this.entities.getValue().booleanValue() && this.Mules.getValue().booleanValue()) {
            for (Entity entity : Notifications.mc.world.getLoadedEntityList()) {
                ...
                if (this.Desktop.getValue().booleanValue()) {
                    this.icon.displayMessage("ChickenWings.cc", "I found a mule at: " + Math.round(entity.getPosition().getX()) + ", " + Math.round(entity.getPosition().getY()) + ", " + Math.round(entity.getPosition().getZ()) + ".", TrayIcon.MessageType.INFO);
                }
                if (!this.Sound.getValue().booleanValue()) continue;
                Notifications.mc.player.playSound(SoundEvents.BLOCK_ANVIL_DESTROY, 1.0f, 1.0f);
            }
        ...
        if (this.entities.getValue().booleanValue() && this.Llamas.getValue().booleanValue()) {
            for (Entity entity : Notifications.mc.world.getLoadedEntityList()) {
                ...
                if (this.Desktop.getValue().booleanValue()) {
                    this.icon.displayMessage("ChickenWings.cc", "I found a llama at: " + Math.round(entity.getPosition().getX()) + ", " + Math.round(entity.getPosition().getY()) + ", " + Math.round(entity.getPosition().getZ()) + ".", TrayIcon.MessageType.INFO);
                }
                if (!this.Sound.getValue().booleanValue()) continue;
                Notifications.mc.player.playSound(SoundEvents.BLOCK_ANVIL_DESTROY, 1.0f, 1.0f);
            }
        ...
        if (this.pearls.getValue().booleanValue()) {
            ...
            if (closestPlayer != null && this.flag) {
                ...
                Command.sendSilentMessage(OyVey.friendManager.isFriend(closestPlayer.getName()) ? ChatFormatting.AQUA + closestPlayer.getName() + ChatFormatting.DARK_GRAY + " has just thrown a pearl heading " + facing + "!" : ChatFormatting.RED + closestPlayer.getName() + ChatFormatting.DARK_GRAY + " has just thrown a pearl heading " + facing + "!");
                this.flag = false;
            }
        }
    ...
    public void onToggleModule(ClientEvent event) {
        ...
        if (!(event.getStage() != 0 || (module = (Module)event.getFeature()).equals(this) || !modules.contains(module.getDisplayName()) && this.list.getValue().booleanValue())) {
            ...
            if (this.watermark.getValue().booleanValue()) {
                ...
                if (this.bold.getValue().booleanValue()) {
                    TextComponentString textComponentString2 = new TextComponentString(OyVey.commandManager.getClientMessage() + " " + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RED + " disabled.");
        ...
        if (event.getStage() == 1 && (modules.contains((module = (Module)event.getFeature()).getDisplayName()) || !this.list.getValue().booleanValue())) {
            ...
            if (this.watermark.getValue().booleanValue()) {
                ...
                Notifications.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion((ITextComponent)textComponentString, moduleNumber);
                if (this.bold.getValue().booleanValue()) {
                    TextComponentString textComponentString2 = new TextComponentString(OyVey.commandManager.getClientMessage() + " " + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.GREEN + " enabled.");
                    Notifications.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion((ITextComponent)textComponentString2, moduleNumber);
                }
            } else {
