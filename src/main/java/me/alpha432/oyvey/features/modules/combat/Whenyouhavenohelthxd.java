...
public class Whenyouhavenohelthxd
        extends Module {
    ...
    private List<BlockPos> getPositions() {
        ...
        positions.add(new BlockPos(Whenyouhavenohelthxd.mc.player.posX, Whenyouhavenohelthxd.mc.player.posY + 2.0, Whenyouhavenohelthxd.mc.player.posZ));
        ...
        switch (placeability) {
            ...
            case 2: {
                positions.add(new BlockPos(Whenyouhavenohelthxd.mc.player.posX + 1.0, Whenyouhavenohelthxd.mc.player.posY + 1.0, Whenyouhavenohelthxd.mc.player.posZ));
                positions.add(new BlockPos(Whenyouhavenohelthxd.mc.player.posX + 1.0, Whenyouhavenohelthxd.mc.player.posY + 2.0, Whenyouhavenohelthxd.mc.player.posZ));
            }
        }
    ...
    private void placeBlock(BlockPos pos) {
        if (this.blocksThisTick < this.blocksPerTick.getValue()) {
            ...
            int originalSlot = Whenyouhavenohelthxd.mc.player.inventory.currentItem;
            int obbySlot = InventoryUtil.findHotbarBlock(BlockObsidian.class);
            int eChestSot = InventoryUtil.findHotbarBlock(BlockEnderChest.class);
            if (obbySlot == -1 && eChestSot == -1) {
                this.toggle();
            }
            Whenyouhavenohelthxd.mc.player.inventory.currentItem = obbySlot == -1 ? eChestSot : obbySlot;
            Whenyouhavenohelthxd.mc.playerController.updateController();
            ...
            Whenyouhavenohelthxd.mc.player.inventory.currentItem = originalSlot;
            Whenyouhavenohelthxd.mc.playerController.updateController();
            this.timer.reset();
            ++this.blocksThisTick;
        }
    ...
    private boolean check() {
        ...
        if (!EntityUtil.isSafe(Whenyouhavenohelthxd.mc.player)) {
            this.offTimer.reset();
            return true;
        }
