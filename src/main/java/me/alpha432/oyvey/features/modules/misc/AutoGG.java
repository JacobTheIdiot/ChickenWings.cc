...
public class AutoGG
    ...
    public Setting<String> custom = this.register(new Setting<String>("Custom", "ChickenWings.cc"));
    ...
    public AutoGG() {
        super("AutoNice", "Sends msg after you kill someone", Module.Category.MISC, true, false, false);
        this.setInstance();
    }
